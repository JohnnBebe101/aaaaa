...
import { SectionTitle, CanaanPattern, Container, Badge, HeritageFrieze, Button } from '../components/CommonUI';
...
const Culture: React.FC = () => {
  return (
    <div className="animate-in fade-in duration-700">
      ...
      {/* The Story Section */}
      <section className="py-32 bg-white overflow-hidden" aria-labelledby="heritage-title">
        <Container className="flex flex-col lg:flex-row items-center gap-24">
          <div className="flex-1 relative">
             <div className="relative p-6 border border-cactus/10 rounded-2xl bg-sandstone/30">
                <img 
                    ...
                    alt="Authentic traditional Tigrayan art and textiles" 
                    className="w-full aspect-[4/5] object-cover rounded-sm grayscale opacity-90 shadow-2xl"
                />
                <div className="absolute -top-6 -left-6 w-32 h-32 border-t-8 border-l-8 border-cactus hidden md:block" aria-hidden="true"></div>
             </div>
          </div>
          <div className="flex-1">
            ...
            <div className="space-y-8 text-gray-600 leading-relaxed text-lg font-light">
                ...
                <div className="grid grid-cols-2 gap-8 pt-8" role="list" aria-label="Heritage statistics">
                    <div role="listitem">
      ...
      <section className="py-32 bg-sandstone" aria-labelledby="dining-title">
        <Container>
            <div className="flex flex-col lg:flex-row gap-16">
                <div className="flex-1">
                    ...
                    />
                    <div className="space-y-6" role="list" aria-label="Dining menu preview">
                        {[
                            ...
                            <div key={i} role="listitem" className="flex justify-between items-end border-b border-cactus/10 pb-4 group cursor-default">
                ...
                <div className="flex-1 bg-forest p-16 text-sandstone flex flex-col justify-center items-center text-center rounded-sm">
                    <Coffee className="w-16 h-16 text-cactus mb-10" aria-hidden="true" />
                    ...
                    <button 
                      className="text-[10px] uppercase tracking-[0.4em] font-bold text-cactus border-b border-cactus pb-2 hover:text-sandstone hover:border-sandstone transition-all"
                      aria-label="Book a private ceremonial coffee experience"
                    >
      ...
      <HeritageFrieze aria-hidden="true" />
      <CanaanPattern inverted aria-hidden="true" />
    </div>
  );
};
